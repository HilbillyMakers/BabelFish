...
#define EP0_IN_BUFF_OFFSET      (0)
#define EP0_OUT_BUFF_OFFSET     (0)

#define EP1_IN_ADDR             (USB_DIR_IN  | 1)
#define EP1_OUT_ADDR            (USB_DIR_OUT | 1)
#define EP1_IN_BUFF_OFFSET      (0 * 64)
#define EP1_OUT_BUFF_OFFSET     (1 * 64)

#define EP2_IN_ADDR             (USB_DIR_IN  | 2)
#define EP2_OUT_ADDR            (USB_DIR_OUT | 2)
#define EP2_IN_BUFF_OFFSET      (2 * 64)
#define EP2_OUT_BUFF_OFFSET     (3 * 64)
...
static const struct usb_endpoint_descriptor ep2_out = 
{
        .bLength                = sizeof(struct usb_endpoint_descriptor),
        .bDescriptorType        = USB_DT_ENDPOINT,
        .bEndpointAddress       = EP2_OUT_ADDR, // EP number 2, OUT from host (rx from device)
        .bmAttributes           = USB_TRANSFER_TYPE_BULK,
        .wMaxPacketSize         = 64,
        .bInterval              = 0
};
